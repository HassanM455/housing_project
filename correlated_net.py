...
corrAbovept5 = corr[(corr.SalePrice > 0.3)].SalePrice.index

print(corrAbovept5)
corrAbovept5 = np.delete(corrAbovept5, 0)
print(corrAbovept5)

n_file_clean_89rowsdropped = n_file_clean_89rowsdropped[corrAbovept5]
...
for i in range(len(X_train_clean_89rows)):
    ...
    print('where1 has %s nans and infs' %str(len(where1)))
...
layers = [200,150,100,50,20,10,5,2]
